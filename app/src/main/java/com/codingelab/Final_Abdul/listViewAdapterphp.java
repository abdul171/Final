...
public class listViewAdapterphp {
    public ArrayList<infophp> personlist;
    Activity activity;
    //SearchActivity s;

    public listViewAdapterphp(Activity activity, ArrayList<infophp> personlist) {
        super();
        this.activity = activity;
        this.personlist = personlist;
    }
   /* public listViewAdapterphp(SearchActivity activity, ArrayList<infophp> personlist) {
        super();
        this.s = activity;
        this.personlist = personlist;
    }*/
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        infophp item = personlist.get(position);
