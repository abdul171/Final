...
public class Listviewupdatephp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getJSON("http://192.168.43.253:80/sqli/getData.php");
        final Intent intent = new Intent(this, Dbupdatephp.class);
