    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View view,
                ...
                // رسالة
                alert.setMessage("Are You Sure To Remove Select Item ?");
                // خيار نعم
                alert.setPositiveButton("Sure",
                ...
                alert.setNegativeButton("Not Sure",
                        new DialogInterface.OnClickListener() {
...
//ResultActivity.this.adapter.getFilter.filter(cs);
                ...
                List<Info> cont = mydb.SearchWords(Search.getText().toString());
