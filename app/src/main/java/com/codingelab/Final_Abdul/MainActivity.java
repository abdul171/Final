...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.onSyn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    // سح كافة البيانات الموجودة في قاعدة البيانات علي السيرفر
                    TruncateServerTable();
                    //ادخال جميع البيانات الموجودة في قاعدة البيانات المحلية إلي السيرفر
                    SyncData();
    ...
    // فتح قاعدة البيانات المحلية
    btndbphp = (Button) findViewById(R.id.btndbphp);
    final Intent sqlphp = new Intent(MainActivity.this, PHPmainActivity.class);
        btndbphp.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            startActivity(sqlphp);
        }
    });
    ...
    private void TruncateServerTable() {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("http://192.168.43.253:80/sqli/mysql_truncate.php");
